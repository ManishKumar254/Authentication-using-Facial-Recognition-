...
krish_image = face_recognition.load_image_file("Manish/manishseo254@gmail.com.jpg")
krish_face_encoding = face_recognition.face_encodings(krish_image)[0]

# Load a second sample picture and learn how to recognize it.
bradley_image = face_recognition.load_image_file("Manish/anish123@gmail.com.jpg")
...
print('<body>')
if name_1[0]==pn:
    print('<h1>Hi %s you are logged in successfully!!</h1>'%name_1[0])
else:
